...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (downloadBtn) {
        downloadBtn.addEventListener('click', function() {
            ...
            link.href = 'https://drive.google.com/uc?export=download&id=1NRyTXAampxFC6hiEB76P7y_1hdZ4txHS'; // Update with your actual file path
            ...
            setTimeout(() => {
                if (!document.querySelector('a[href*=".pdf"]')) {
                    window.open('https://drive.google.com/uc?export=download&id=1NRyTXAampxFC6hiEB76P7y_1hdZ4txHS', '_blank');
                }
            }, 500);
        });
    }
